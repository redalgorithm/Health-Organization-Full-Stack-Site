...
<?php	// connecting to database server
	...
	*/
	...
	if (isset($_POST['Email']) && isset($_POST['Pass']) &&
	    isset($_POST['ProviderLast']) && isset($_POST['ProviderFirst'])
	    ...
	    isset($_POST['Zip']))
	{
		...
		$Pass  = get_post('Pass');
		$ProviderLast = get_post('ProviderLast');
		$ProviderFirst = get_post('ProviderFirst');
		$DoB = get_post('DoB');
		...
		$sql = "INSERT INTO PROVIDER (`Email`, `Pass`, `ProviderLast`,
			 `ProviderFirst`,`Dob`,`Country`, `State`, `City`,
			 `Zip`, `Address`, `Apt`) VALUES ('$Email', '$Pass', 
			 '$ProviderLast','$ProviderFirst', '$DoB', 
